...
export interface UpgradePolicy {
  mode?: version20180601.UpgradeMode;
	/**
   * The configuration parameters used while performing a rolling upgrade.
   */
  rollingUpgradePolicy?: version20180601.RollingUpgradePolicy;
...
export interface AutomaticRepairsPolicy {
   ...
   */
  enabled?: boolean & adltypes.DefaultValue<true>;
   ...
   */
  gracePeriod?: adltypes.duration & adltypes.DefaultValue<"PT30M">;
}
...
export type VirtualMachineScaleSet20181001 = armtypes.ArmVersionedResource<VirtualMachineScaleSet20181001Properties>;
